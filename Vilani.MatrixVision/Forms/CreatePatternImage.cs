...
namespace Vilani.MatrixVision
{
    ...
    public partial class CreatePatternImage : Form
    {
        ...
        public CreatePatternImage(System.Drawing.Image currentReferenceImage)
        {
            InitializeComponent();
        ...
        private void btnUploadImage_Click(object sender, EventArgs e)
        {
            ...
            if (open.ShowDialog() == DialogResult.OK)
            {
                ...
                this.pictureBoxLive.Image = image2;
        ...
        private void pictureBoxLive_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            if (this._bIsToMarkROI)
            {
				...
				{
					this.rectCropArea.X * 4,
					this.rectCropArea.Y * 4,
					this.rectCropArea.Width * 4,
					this.rectCropArea.Height * 4
				});
                rectAOI.X = this.rectCropArea.X * 4;
                rectAOI.Y = this.rectCropArea.Y * 4;
                rectAOI.Width = this.rectCropArea.Width * 4;
                rectAOI.Height = this.rectCropArea.Height * 4;
